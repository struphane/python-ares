...
class Report(object):
  ...
  def scatterline(self, values, header, headerBox=None, cssCls=None, cssAttr=None, mockData=False): return self.add(aresFactory['NvD3ScatterPlusLineChart'](self, headerBox, self.register(self.suppRec(values), header), header, cssCls, cssAttr, mockData), sys._getframe().f_code.co_name)
