...
class Report(object):
  ...
  # Chart section
  def bar(self, header, values, mapCols, cssCls=None): return self.add(AresHtmlGraph.Bar(self.getNext(), header, values, mapCols, cssCls), sys._getframe().f_code.co_name)
  def pieChart(self, header, values, mapCols, cssCls=None): return self.add(AresHtmlGraph.Pie(self.getNext(), header, values, mapCols, cssCls), sys._getframe().f_code.co_name)
  def donutChart(self, header, values, mapCols, cssCls=None): return self.add(AresHtmlGraph.Donut(self.getNext(), header, values, mapCols, cssCls), sys._getframe().f_code.co_name)
