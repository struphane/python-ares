...
class Report(object):
  ...
  def xmeter(self, singleSeries=None, multiSeries=None, headerBox=None, chartDesc=None, cssCls=None, cssAttr=None, inReport=True):
    return self.add(aresFactory['XNvD3Meter'](self, headerBox, singleSeries=singleSeries, multiSeries=multiSeries, chartDesc=chartDesc, cssCls=cssCls, cssAttr=cssAttr), sys._getframe().f_code.co_name, inReport)
  ...
  def xhbar(self, singleSeries=None, multiSeries=None, headerBox=None, chartDesc=None, cssCls=None, cssAttr=None, inReport=True):
    return self.add(aresFactory['XNvD3HorizontalBars'](self, headerBox, singleSeries=singleSeries, multiSeries=multiSeries, chartDesc=chartDesc, cssCls=cssCls, cssAttr=cssAttr), sys._getframe().f_code.co_name, inReport)
  def xscatter(self, singleSeries=None, multiSeries=None, headerBox=None, chartDesc=None, cssCls=None, cssAttr=None, inReport=True):
    return self.add(aresFactory['XNvD3ScatterChart'](self, headerBox, singleSeries=singleSeries, multiSeries=multiSeries, chartDesc=chartDesc, cssCls=cssCls, cssAttr=cssAttr), sys._getframe().f_code.co_name, inReport)
  def xarea(self, singleSeries=None, multiSeries=None, headerBox=None, chartDesc=None, cssCls=None, cssAttr=None, inReport=True):
    return self.add(aresFactory['XNvD3StackedAreaWithFocus'](self, headerBox, singleSeries=singleSeries, multiSeries=multiSeries, chartDesc=chartDesc, cssCls=cssCls, cssAttr=cssAttr), sys._getframe().f_code.co_name, inReport)
