...
class Report(object):
  ...
  def horizBarChart(self, values, header, headerBox=None, cssCls=None, cssAttr=None, mockData=False): return self.add(aresFactory['NvD3HorizontalBars'](self, headerBox, values, header, cssCls, cssAttr, mockData), sys._getframe().f_code.co_name)
