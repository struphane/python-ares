...
\YouFolderName
  ...
  \data # All the text files that your script will produce (user based security)
  ...
  \static # All the static files required to run your report (static data shared by all users)
...
def createEnv(reportName, deleteIfExist):
  ...
  for subFolder in ['ajax', 'static', 'data', 'styles', 'saved', 'utils']:
