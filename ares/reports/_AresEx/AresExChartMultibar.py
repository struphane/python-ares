...
def report(aresObj):
  ...
  aresObj.preformat(
    '''
      [{"CCY": 'EUR', "PTF": '123', 'VAL': 13, 'VAL2': -43, 'COB': '2017-10-18'},
       ...
       {"CCY": 'GBP', "PTF": '34', 'VAL': 72, 'VAL2': -64, 'COB': '2017-10-19'},
       {"CCY": 'USD', "PTF": '74', 'VAL': 25, 'VAL2': -13, 'COB': '2017-10-19'}]
    '''
  )
  recordSet = [{"CCY": 'EUR', "PTF": '123', 'VAL': 13, 'VAL2': -43, 'COB': '2017-10-18'},
               {"CCY": 'GBP', "PTF": '124', 'VAL': 64, 'VAL2': -34, 'COB': '2017-10-18'},
               {"CCY": 'GBP', "PTF": '34', 'VAL': 72, 'VAL2': -64, 'COB': '2017-10-19'},
               {"CCY": 'EUR', "PTF": '123', 'VAL': 13, 'VAL2': -43, 'COB': '2017-10-19'},
               {"CCY": 'USD', "PTF": '74', 'VAL': 25, 'VAL2': -13, 'COB': '2017-10-19'}]
  ...
  aresObj.title4("Display a 2D donut chart with multiple keys and values")
  comboLineBar = aresObj.comboLineBar(recordSet, header)
  comboLineBar.setSeries(['CCY', "PTF"])
  comboLineBar.setX('COB') #
  comboLineBar.setY(['VAL', 'VAL2'])
  comboLineBar.formatSeries({'EUR': True}, {'GBP': 'yellow', 'USD': 'red'})
