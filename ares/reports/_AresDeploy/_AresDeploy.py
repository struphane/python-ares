...
def report(aresObj):
  ...
  aresObj.title('Deployment Tool')
  aresObj.radio([{'status': 'NEW'}, {'status': 'EXISTING'}], 'status', [{'key': 'status', 'colName': 'Status'}])
  aresObj.newline()
  aresObj.input('Please indicate the environment on which you would like to deploy')
  aresObj.deployFiles('')
